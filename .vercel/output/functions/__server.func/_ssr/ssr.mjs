...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DMkIDAi3.mjs");
...
var manifest = { "456e918a2d517c12888cfc8f8b446e4f87311467bf0c585b4d8260dc51d3a365": {
	functionName: "askAlpha_createServerFn_handler",
	importer: () => import("./ai-6O8hcnNf.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BESfIgdw.mjs").then((n) => n.t),
